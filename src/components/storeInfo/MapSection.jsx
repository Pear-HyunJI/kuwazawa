...
const MapSectionBlock= styled.div`
                    ...
                    <div className="option">
                        <div>
                            <form onSubmit={(e)=>{ e.preventDefault(); searchPlaces()}}>
                                <input type="text" id="keyword" placeholder="kuwazawa를 검색하세요." onChange={(e)=>setKeyword(e.target.value)} value={keyword} />  
